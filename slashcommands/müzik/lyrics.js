...
module.exports = {
    inDev: true,
    data: new SlashCommandBuilder().setName("lyrics").setDescription("Belirtilen şarkının sözlerini gösterir.").addStringOption(option => option.setName("şarkı").setDescription("Lütfen hangi şarkının sözlerini istediğinizi belirtin.")),
